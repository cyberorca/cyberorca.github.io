...
window.createCDPTracker = function(cat, campaignName){
    var cName ='liputan6_id_visitor_id=',
        ...
        partnerUID ? window.VidioPersonalization.sendData(partnerUID, cdpData) : '';
};
...
googletag.cmd.push(function() {
    ...
    /*Bottom Frame Scrolling*/
    var _countAdUnit = 0,
    _slots = kly.pageType !== "ReadPage" ? [8,9] : [10,11,12],
    _send = false;
